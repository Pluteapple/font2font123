...
parser.add_argument('--workers', default=0, type=int, help='the number of workers of data loader')
...
parser.add_argument('--iters', default=2500, type=int, help='Total number of iterations per epoch')
parser.add_argument('--batch_size', default=1, type=int,
                    help='Batch size for training')
parser.add_argument('--val_num', default=800, type=int,help='Number of test images for each style')
...
parser.add_argument('--img_size', default=100, type=int, help='Input image size')
...
def main():
    ...
    not_dirs = ['.idea', '.git', 'logs', 'results', '.gitignore', '.nsmlignore', 'resrc', 'resultsnew1']
